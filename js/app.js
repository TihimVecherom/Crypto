(() => {
    ...
    (() => {
        ...
        if (menuBurger) menuBurger.addEventListener("click", (function(e) {
            ...
            if (menuBody) menuBody.classList.toggle("_menu-burger-active");
        }));
        const cards = document.querySelectorAll(".swiper-video-slide__picture-ibg");
        cards.forEach((card => {
            let videoBody = card.querySelector(".media-video");
